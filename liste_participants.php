...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60" onload="changecolor(3)">
    ...
    <div class="container">
        ...
        <center>
            ...
            <?php
                $rq=$db->prepare("SELECT* FROM participants ORDER BY noms_et_prenoms asc");
                            $rq->execute();
                ...
                if($n<0){
                    ...
                    for($i=0;$i<=$n;$i++){
		                     ...
		                     echo '<tr><td>'.
                                 ...
                                 utf8_decode($part[$i]['email']).'</td><td>'.
                                 utf8_decode($part[$i]['nationalite']).'</td><td>'.
                                 utf8_decode($part[$i]['phone']).'</td><td>'.
                                 utf8_decode($part[$i]['nombre_de_participation']).'</td></tr>';
                    }
		                    echo '</tbody>  
								</table>
                                </div>';
